...
<div class="padder"> <!-- Padder for welcome box -->
    <div id="Welcome" class="centerBox">
        ...
        <img src="Pictures/WelcomeImage.webp" alt="">
    </div>
</div>
<div id="breakthroughDifference">
    <div class="padder">
        <div class="centerBox">
            <div>
                <h2>The Breakthrough Difference</h2>
                <p>
                We all need <span>fitness</span> in our lives.
                <br><br>
                Some of us need a little <span>motivation</span> and <span>guidance</span>.
                <br><br>
                Some of us may have Autism or Down Syndrome.
                <br><br>
                Some of us have experienced <span>injuries</span> or setbacks, such as a knee or hip replacement.
                <br><br>
                Some of us are <span>athletes</span> who are looking to excel in a particular sport.
                <br><br>
                Regardless of where you are starting, your story is not done, so come as you are. <span>All are welcome</span>.
                <br><br>
                Let’s work together to <span>unlock your purpose</span>, power, and potential.
                <br><br>
                We are an appointment-based fitness facility that exists to create <span>equal access</span> to health and fitness for all. Exercise and a balanced lifestyle are the first line of defense against an array of things that life can throw at us. We want to help you to not only <span>achieve your goals</span>, but live with the better quality of life we all deserve.
                </p>
            </div>
            <img loading="lazy" alt="Staff and a client posing" src="Pictures/breakthroughDifference.webp">
        </div>
    </div>
</div>
<div id="map">
        ...
        <div class="centerBox">
            ...
            <div id="socials">
                <a href="tel:9143584575" target="_blank">
                    <svg viewBox="0 0 16 16" fill="currentColor" width="32px" height="32px" style="fill: limegreen;">
                        <g>
                    ...
                    <svg viewBox="0 0 16 16" fill="currentColor" width="32px" height="32px" style="fill: #1877F2">
                        <g>
